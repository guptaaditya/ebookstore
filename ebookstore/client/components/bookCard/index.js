    ...
    return (
      ...
      cursor: "pointer"}}>
        <div>
          <div>
            <div>
                ...
                {{width: "170px", height: "240px",
                 position: "relative"}}>
                   <img style={{width: "170px", height: "240px"}}src="https://media.logos.social/150x250/f06db8b6-8c85-4a89-9ee5-f2da56c05191.png"/>
                </div>
              ...
              width: "27px", height: "43px",
               ...
               boxShadow: "rgba(0, 0, 0, 0.2) 0px 2px 12px 0px">
                <span style={{width: "15px", height: "15px", position: "absolute", marginLeft: "6px", marginTop: "14px"}} >
              </span>
            </div>
          ...
          <div style={{
            fontSize: "12px" width: "125px", height: "26px",
           fontWeight: "600"; overflow: "hidden", textOverflow: "ellipsis",
           whiteSpace: "nowrap", color: "rgb(48, 64, 59)"}}>100 Pipers <br/> <span style={{fontSize:"10px"}}>Chetan Anagalam</span>
         </div>
